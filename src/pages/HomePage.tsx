...
export default function HomePage() {
  return (
    <>
        ...
        <div className="grid min-h-screen px-8">
          <div className="container relative z-10 my-auto mx-auto grid place-items-center text-center">
            ...
            <p className="block antialiased font-sans text-xl font-normal leading-relaxed text-white mt-4 mb-6 w-full md:max-w-full lg:mb-12 lg:max-w-3xl">
              Take part in preserving our culture and nature where every
              souvenir connects you to the soul of the Philippines.
            </p>
      ...
      <section className="relative w-full bg-gradient-to-b py-16 px-6 md:px-16">
          ...
          <div className="space-y-10 text-slate-800">
            <div>
              ...
              <p className="text-gray-500 leading-relaxed max-w-3xl mx-auto">
                HANDUMANAN aims to promote sustainable tourism by offering
                eco-friendly souvenirs that share stories about local
                destinations and culture. Through QR codes, we connect travelers
                to meaningful experiences while supporting local artisans and
                communities.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-500 leading-relaxed max-w-3xl mx-auto">
                HANDUMANAN envisions becoming a leading platform for sustainable
                and cultural souvenirs that inspire travelers to appreciate and
                protect both local culture and the environment.
              </p>
            </div>
