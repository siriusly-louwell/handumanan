...
export default function Header() {
  return (
    <div className="bg-gray-100 font-sans w-[170vh]">
      <div className="bg-fine shadow">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            <h2 className="font-semibold text-xl font-poppins text-accent">
              Handumanan
            </h2>

            <div className="hidden sm:flex sm:items-center space-x-5 pr-10">
              <NavLink
                to="/"
                className={({ isActive }) =>
                  isActive
